...
class LoraMesh : public Component {
 public:
  ...
  void set_node_id(std::string id) { this->node_id_str_ = std::move(id); }
  void set_node_id(std::function<std::string()> id_func) { this->node_id_func_ = std::move(id_func); }
 ...
 protected:
  ...
  std::function<std::string()> node_id_func_{nullptr};
